                        ...
                        const buffer_t buffer, const int length)
{
    ...
    {
        //verbprintf(1, "morse_demod %d", buffer.sbuffer[i] );
            ...
            if(oldstate == LOW)
            {
                ...
                if(s->l1.morse.samples_since_change >= 2*s->l1.morse.time_unit_gaps_samples)
                {
                    ...
                    if(s->l1.morse.current_sequence)
                    {
                        ...
                        verbprintf(0,"sending %s to java ", rtn.string_ptr);
                        send_char_to_java(rtn.string_ptr[0]);
                    ...
                    {
                        if(rtn.status)
                            verbprintf(0,"sending space to java ");
                            send_char_to_java(' ');
